                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <div class="flex items-center gap-3">
                            ...
                            <h3 class="text-base font-semibold text-gray-800">All Menu Items</h3>
                        </div>
                        <a
                                    ...
                                    <tr class="hover:bg-gray-50 transition">
                                        <td class="px-4 py-3">
                                            @if($menu->image)
                                                ...
                                                >
                                            @else
                                                <div class="w-12 h-12 bg-gray-100 rounded-lg flex items-center justify-center text-gray-300">
                                        ...
                                        <td class="px-4 py-3 font-medium text-gray-800">{{ $menu->Rice_name }}</td>
                                        <td class="px-4 py-3 text-gray-600">${{ number_format($menu->Price, 2) }}</td>
                                        <td class="px-4 py-3 text-right">
                                            <div class="flex items-center justify-end gap-2">
                                                ...
                                                <form action="{{ route('menu.delete', $menu->id) }}" method="POST" onsubmit="return confirm('Delete this menu item?')">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button
                                                        type="submit"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-4 py-10 text-center text-gray-400 text-sm">
                                            No menu items yet. <a href="{{ route('menu.create') }}" class="text-amber-500 hover:underline">Add one now.</a>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
